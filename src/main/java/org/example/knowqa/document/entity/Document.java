...
public class Document extends BaseEntity{
    ...
    public Document create(DocumentUploadParam documentUploadParam) {
        this.setDocTitle(documentUploadParam.getTitle());
        this.setStatus(DocumentStatus.UPLOADED);
        this.setDescription(documentUploadParam.getDescription());
        return this;
    }
    ...
    public void setSplitParam(DocumentSplitParam param) {
        ...
        spMap.put("splitType", param.getSplitType());
        spMap.put("chunkSize", param.getChunkSize());
        spMap.put("overlap", param.getOverlap());
        spMap.put("titleLevel", param.getTitleLevel());
        spMap.put("separator", param.getSeparator());
        spMap.put("regex", param.getRegex());
